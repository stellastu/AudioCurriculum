// src/lib.rs
/*
 * Core library for AudioCurriculum
 */
...
#[derive(Debug)]
pub struct AudioCurriculumProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AudioCurriculumProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AudioCurriculum processing");
    
    let mut processor = AudioCurriculumProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AudioCurriculumProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AudioCurriculumProcessor::new(false);
